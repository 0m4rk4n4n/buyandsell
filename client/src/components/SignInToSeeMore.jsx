...
<p style={{textAlign:"center",color:"#fff"}}>See more relevant listings, find what you’re looking for quicker, and more!</p>
                <br/>
<button className="SignInToSeeMoreBtn" style={{display:"block",cursor:"pointer",margin:"10px auto",borderRadius:5,padding:5,borderColor:"transparent"}}><Link style={{textDecoration:"none",color:"inherit"}} to="/login">Sign In</Link></button>
        </div>
    </div>
</div>
</>)
