...
useEffect(()=>{window.scrollTo({ top: 0 });},[])
    return (
        ...
        <h2 style={{textAlign:"center",color:"#373373",fontSize:25}}>Welcome to Sellsphere – Your One-Stop Marketplace!</h2>
        <br/><br/>
        ...
        <p>At Sellsphere, we understand the importance of community. That's why we provide a platform where users can connect with each other, discuss listings, and build lasting relationships. Our user-friendly chat feature allows you to communicate directly with sellers or buyers, making the buying and selling process smoother than ever before.</p>
        <br/>
        <h3>Your Safety, Our Priority</h3>
        <p>We take your safety seriously. Sellsphere employs advanced security measures to ensure a secure and trustworthy environment for all users. We verify user profiles and monitor listings to protect you from potential scams or fraudulent activities.</p>
        <br/>
        <h3>How It Works</h3>
        <div>
          <div>1. Create an Account: Sign up for your free Sellsphere account to get started.</div>
        ...
        <br/>
        <h3>Join the Sellsphere Community Today!</h3>
        <p>Whether you're a seasoned online shopper or a first-time user, Sellsphere offers a welcoming platform that caters to all your buying and selling needs. Discover the endless possibilities that await you and be part of our growing community.</p>
        <p>Get started now and experience the convenience, safety, and reliability of Sellsphere. Your next great opportunity or cherished possession is just a click away!</p>
      </div>
        </div>
      <Footer/>
        </>
