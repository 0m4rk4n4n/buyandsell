...
setTimeout(() => {
  ...
  const handleDelete=()=>
  {
    const fun=async()=>
    {
      try 
      {
        await axiosInstance.delete(`/services/deleteAd/${path.id}`) && navigate(-1)
      }
      catch(e)
      {
...
<div><span style={{color:"rgb(55, 51, 115)",fontWeight:"600"}}>Type:</span><span style={{fontWeight:"500",color:"#61635f"}}>{" Service"}</span></div>
</div>
<div style={{display:"flex",alignItems:"center",gap:10}}>
<AttachMoneyIcon/>
<div><span style={{color:"rgb(55, 51, 115)",fontWeight:"600"}}>Price/Fee:</span><span style={{fontWeight:"500",color:"#61635f"}}>{" $"}{ad.price}</span></div>
</div>
</div>
<div>
...
<div><span style={{color:"rgb(55, 51, 115)",fontWeight:"600"}}>Date Modified:</span><span style={{fontWeight:"500",color:"#61635f"}}>{" "}{ad.createdAt===ad.updatedAt ? "Never" : ad.updatedAt}</span></div>
                ...
                <div className="col-lg-4 col-sm-2 adHeader22">
        ...
        <div className="container">
          <div  className="row">
            <div className="col-sm-12">
              <div className="row">
                <div className="col-sm-12">
                  <div className="fromAutos" style={{fontWeight: "bold",fontSize: 30,color: "#373373",}}>From Services in {location}</div>
                  <br />
                  <br />
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  <div className="jobId">
