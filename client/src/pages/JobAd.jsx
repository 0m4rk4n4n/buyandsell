...
setTimeout(() => {
  ...
  const handleDelete=()=>
  {
    const fun=async()=>
    {
      try 
      {
        await axiosInstance.delete(`/jobs/deleteAd/${path.id}`) && navigate(-1)
      }
      catch(e)
      {
  ...
  useEffect(() => {
    const fun = async () => {
      setLoading(true)
      const res = await axiosInstance.get(`/jobs/getsinglead/${path.id && path.id}`);
      setAd(res.data);
  ...
  const x = useRef();
  const handleReveal = () => {
    x.current.innerHTML = user.phone;
  };
  return (
    <>
...
<AttachMoneyIcon/>
<div><span style={{color:"rgb(55, 51, 115)",fontWeight:"600"}}>Salary:</span><span style={{fontWeight:"500",color:"#61635f"}}>{" $"}{ad.salary===45000 ? "40,000 - 50,000 / Year" : ad.salary===55000 ? "50,000 - 60,000 / Year" : ad.salary===65000 ? "60,000 - 70,000 / Year" : ad.salary===75000 ? "70,000 - 80,000 / Year" : ad.salary===85000 ? "80,000 - 90,000 / Year" : ad.salary===95000 ? "90,000 - 100,000 / Year" : "100,000 / Year"}</span></div>
</div>
</div>
<div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              <div className="row">
                <div className="col-sm-12">
                  <div className="fromAutos" style={{fontWeight: "bold",fontSize: 30,color: "#373373",}}>From Jobs in {location}</div>
                  <br />
                  <br />
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                  <div className="jobId">
